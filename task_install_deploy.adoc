...
. Après le déploiement de la machine virtuelle, sélectionnez la nouvelle machine virtuelle et mettez-la sous tension si elle ne l'est pas déjà, en fonction de votre saisie dans l'assistant de déploiement.
