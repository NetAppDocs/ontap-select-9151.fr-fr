...
NOTE: La surcharge VMFS n'est pas nulle (voir VMware KB 1001618), et la tentative d'utiliser l'intégralité de l'espace indiqué comme libre par un datastore a entraîné des erreurs parasites lors des opérations de création de cluster.
